...
echo "static uint64_t mem_ctl_lock = $mem_ctl_lock;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_err_rate = $mem_ctl_err_rate;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_err_severity = $mem_ctl_err_severity;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_locked_addr = $mem_ctl_locked_addr;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_locked_mask = $mem_ctl_locked_mask;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_locked_out = $mem_ctl_locked_out;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "" >> ./src/obfusgem/mem_ctl_obgem.hh
...
echo "static uint64_t rob_lock = $rob_lock;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_err_rate = $rob_err_rate;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_err_severity = $rob_err_severity;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_locked_addr = $rob_locked_addr;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_locked_mask = $rob_locked_mask;" >> ./src/obfusgem/rob_obgem.hh
echo "" >> ./src/obfusgem/rob_obgem.hh
...
echo "static uint64_t scoreboard_reg_idx_lock = $scoreboard_reg_idx_lock;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_err_rate = $scoreboard_err_rate;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_err_severity = $scoreboard_err_severity;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_locked_reg_idx = $scoreboard_locked_reg_idx;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_locked_reg_idx_mask = $scoreboard_locked_reg_idx_mask;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_locked_reg_idx_out = $scoreboard_locked_reg_idx_out;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "" >> ./src/obfusgem/scoreboard_obgem.hh
