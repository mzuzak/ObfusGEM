...
echo "static uint64_t dcache_tag_locked_mask = $dcache_tag_locked_mask;" >> ./src/obfusgem/cache_tag_obgem.hh
...
echo "static uint64_t icache_tag_locked_mask = $icache_tag_locked_mask;" >> ./src/obfusgem/cache_tag_obgem.hh
