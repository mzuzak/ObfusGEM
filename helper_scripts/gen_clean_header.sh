...
echo "// TLB Locking Configuration" >> ./src/obfusgem/tlb_obgem.hh
...
#
# Memory Controller ObfusGEM Configuration
#

# Print Warning Header
echo "// This file is automatically generated for ObfusGEM. Do not Edit!" > ./src/obfusgem/mem_ctl_obgem.hh
echo -e "\n" >> ./src/obfusgem/mem_ctl_obgem.hh

# Print obfuscation configuration
echo "// ObfusGEM Seed" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_obfusgem_seed = $obfusgem_seed;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "" >> ./src/obfusgem/mem_ctl_obgem.hh

echo "// ObfusGEM Injection Mode" >> ./src/obfusgem/tlb_obgem.hh
echo "static uint64_t mem_ctl_obfuscation_mode = $random_obfuscation_mode;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "" >> ./src/obfusgem/mem_ctl_obgem.hh

echo "// Error Rate Denominator" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_err_rate_denom = $err_rate_denom;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "" >> ./src/obfusgem/mem_ctl_obgem.hh

echo "// Memory Controller Locking Configuration" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_lock = 0;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_err_rate = 0;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_err_severity = 0;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_locked_addr = 0;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_locked_mask = 0;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "static uint64_t mem_ctl_locked_out = 0;" >> ./src/obfusgem/mem_ctl_obgem.hh
echo "" >> ./src/obfusgem/mem_ctl_obgem.hh


#
# ROB ObfusGEM Configuration
#

# Print Warning Header
echo "// This file is automatically generated for ObfusGEM. Do not Edit!" > ./src/obfusgem/rob_obgem.hh
echo -e "\n" >> ./src/obfusgem/rob_obgem.hh

# Print obfuscation configuration
echo "// ObfusGEM Seed" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_obfusgem_seed = $obfusgem_seed;" >> ./src/obfusgem/rob_obgem.hh
echo "" >> ./src/obfusgem/rob_obgem.hh

echo "// ObfusGEM Injection Mode" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_obfuscation_mode = $random_obfuscation_mode;" >> ./src/obfusgem/rob_obgem.hh
echo "" >> ./src/obfusgem/rob_obgem.hh

echo "// Error Rate Denominator" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_err_rate_denom = $err_rate_denom;" >> ./src/obfusgem/rob_obgem.hh
echo "" >> ./src/obfusgem/rob_obgem.hh

echo "// ROB Locking Configuration" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_lock = 0;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_err_rate = 0;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_err_severity = 0;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_locked_addr = 0;" >> ./src/obfusgem/rob_obgem.hh
echo "static uint64_t rob_locked_mask = 0;" >> ./src/obfusgem/rob_obgem.hh
echo "" >> ./src/obfusgem/rob_obgem.hh


#
# Scoreboard ObfusGEM Configuration
#

# Print Warning Header
echo "// This file is automatically generated for ObfusGEM. Do not Edit!" > ./src/obfusgem/scoreboard_obgem.hh
echo -e "\n" >> ./src/obfusgem/scoreboard_obgem.hh

# Print obfuscation configuration
echo "// ObfusGEM Seed" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_obfusgem_seed = $obfusgem_seed;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "" >> ./src/obfusgem/scoreboard_obgem.hh

echo "// ObfusGEM Injection Mode" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_obfuscation_mode = $random_obfuscation_mode;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "" >> ./src/obfusgem/scoreboard_obgem.hh

echo "// Error Rate Denominator" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_err_rate_denom = $err_rate_denom;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "" >> ./src/obfusgem/scoreboard_obgem.hh

echo "// Scoreboard Locking Configuration" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_reg_idx_lock = 0;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_err_rate = 0;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_err_severity = 0;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_locked_reg_idx = 0;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_locked_reg_idx_mask = 0;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "static uint64_t scoreboard_locked_reg_idx_out = 0;" >> ./src/obfusgem/scoreboard_obgem.hh
echo "" >> ./src/obfusgem/scoreboard_obgem.hh
